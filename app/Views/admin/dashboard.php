...
<body class="bg-bg-soft font-display min-h-screen flex overflow-x-hidden">
    ...
    <aside id="admin-sidebar" class="fixed inset-y-0 left-0 w-72 bg-white border-r border-slate-200 flex flex-col z-50 transition-transform duration-300 -translate-x-full lg:translate-x-0 lg:sticky lg:top-0 lg:h-screen">
        ...
        <nav class="flex-1 px-4 space-y-1">
            ...
            <a href="#" class="flex items-center gap-4 px-4 py-3.5 bg-primary text-white rounded-2xl font-bold shadow-lg shadow-primary/20 transition">
                <span class="material-symbols-outlined">dashboard</span> Dashboard
            </a>
            <a href="<?= base_url('admin/data-ibu') ?>" class="flex items-center gap-4 px-4 py-3.5 text-slate-500 hover:bg-slate-50 rounded-2xl font-semibold transition">
    ...
    <main class="flex-1 min-w-0 p-4 lg:p-10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            <div class="bg-white p-7 rounded-[2.5rem] shadow-sm border border-slate-100 group hover:border-primary/20 transition">
                <div class="size-12 bg-blue-50 text-primary rounded-2xl flex items-center justify-center mb-5 group-hover:scale-110 transition"><span class="material-symbols-outlined">group</span></div>
                <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Ibu Terdaftar</p>
                <h3 class="text-4xl font-black text-slate-800 tracking-tighter">1,248</h3>
                <p class="text-[10px] text-green-500 font-bold mt-2 italic">+12 Minggu Ini</p>
            </div>
            <div class="bg-white p-7 rounded-[2.5rem] shadow-sm border border-slate-100 group hover:border-primary/20 transition">
                <div class="size-12 bg-amber-50 text-amber-600 rounded-2xl flex items-center justify-center mb-5 group-hover:scale-110 transition"><span class="material-symbols-outlined">assignment_late</span></div>
                <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Perlu Validasi</p>
                <h3 class="text-4xl font-black text-slate-800 tracking-tighter">18</h3>
                <p class="text-[10px] text-amber-500 font-bold mt-2 italic">Segera proses</p>
            </div>
            <div class="bg-white p-7 rounded-[2.5rem] shadow-sm border border-slate-100 group hover:border-primary/20 transition">
                <div class="size-12 bg-rose-50 text-rose-500 rounded-2xl flex items-center justify-center mb-5 group-hover:scale-110 transition"><span class="material-symbols-outlined">heart_broken</span></div>
                <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Resiko Tinggi</p>
                <h3 class="text-4xl font-black text-slate-800 tracking-tighter">5</h3>
                <p class="text-[10px] text-rose-500 font-bold mt-2 italic">Perlu Intervensi</p>
            </div>
            <div class="bg-primary p-7 rounded-[2.5rem] shadow-2xl shadow-primary/20 text-white relative overflow-hidden group">
                <span class="material-symbols-outlined absolute -right-4 -top-4 text-[120px] opacity-10 group-hover:rotate-12 transition-transform">water_drop</span>
                <p class="text-[10px] font-black text-blue-200 uppercase tracking-widest mb-1">Cek Laktasi</p>
                <h3 class="text-4xl font-black tracking-tighter italic">92%</h3>
                <p class="text-[10px] text-blue-100 font-bold mt-2 italic">Kelancaran ASI Rata-rata</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-[3rem] shadow-sm border border-slate-100 overflow-hidden">
            <div class="p-8 border-b border-slate-50 flex flex-col md:flex-row md:items-center justify-between gap-4">
                <h3 class="font-black text-slate-800 italic flex items-center gap-3">
                    <span class="material-symbols-outlined text-primary font-variation-fill">monitoring</span> PEMANTAUAN DATA MASUK
                </h3>
                <div class="flex gap-2">
                    <button class="px-4 py-2 bg-slate-50 text-slate-500 rounded-xl text-xs font-bold border border-slate-100 hover:bg-slate-100 transition">HARI INI</button>
                    <button class="px-4 py-2 bg-primary text-white rounded-xl text-xs font-bold border border-primary transition shadow-md shadow-primary/10">SEMUA DATA</button>
                </div>
            </div>
                        ...
                        <tr class="hover:bg-slate-50/50 transition duration-300">
                            <td class="px-10 py-7">
                                <div class="flex items-center gap-4">
                                    <div class="size-10 rounded-full bg-blue-100 flex items-center justify-center font-bold text-primary">SA</div>
                                    <div>
                                        <p class="font-bold text-slate-800 text-sm italic uppercase tracking-tighter">Sarah Amelia</p>
                                        <p class="text-[10px] text-slate-400">Pusk. Rantau • 28 Thn</p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-10 py-7">
                            ...
                            <td class="px-10 py-7">
                                <div class="flex flex-col gap-1">
                                    ...
                                    <span class="text-[9px] font-bold text-slate-400 italic">RIWAYAT LENGKAP</span>
                                </div>
                            </td>
                            <td class="px-10 py-7">
                                <a href="<?= base_url('admin/detail/1') ?>" class="bg-slate-900 text-white px-5 py-2.5 rounded-xl text-[10px] font-black hover:bg-primary transition uppercase tracking-widest italic">VALIDASI</a>
                            </td>
                        </tr>
                        <tr class="bg-rose-50/30 hover:bg-rose-50 transition duration-300">
                            <td class="px-10 py-7">
                                <div class="flex items-center gap-4">
                                    <div class="size-10 rounded-full bg-rose-100 flex items-center justify-center font-bold text-rose-600">RN</div>
                                    <div>
                                        <p class="font-bold text-slate-800 text-sm italic uppercase tracking-tighter">Bunda Rina</p>
                                        <p class="text-[10px] text-slate-400">Pusk. Bitahan • 31 Thn</p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-10 py-7">
                                <div class="flex items-center gap-2 text-xs font-bold text-rose-600">
                                    <span class="size-1.5 bg-rose-500 rounded-full animate-pulse"></span> RESIKO TINGGI
                                </div>
                            </td>
                            <td class="px-10 py-7 text-center">
                                <span class="bg-rose-600 text-white text-[10px] font-black px-3 py-1.5 rounded-lg uppercase tracking-wider animate-bounce">TIDAK CUKUP</span>
                            </td>
                            <td class="px-10 py-7">
                                <div class="flex flex-col gap-1">
                                    <div class="w-32 h-1.5 bg-slate-100 rounded-full overflow-hidden">
                                        <div class="w-1/2 h-full bg-amber-500"></div>
                                    </div>
                                    <span class="text-[9px] font-bold text-amber-600 italic">MENUNGGU DATA PERSALINAN</span>
                                </div>
                            </td>
                            <td class="px-10 py-7">
                                <button class="bg-rose-600 text-white px-5 py-2.5 rounded-xl text-[10px] font-black hover:bg-rose-700 transition uppercase tracking-widest italic">INTERVENSI</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
