...
<head>
    ...
    <style>
        ...
        .login-split-bg { background: linear-gradient(135deg, #e0f2f1 0%, #b2dfdb 100%); }
    </style>
</head>
<body class="bg-background-light dark:bg-background-dark font-display min-h-screen flex items-center justify-center">
    
    <div id="page-loader" class="fixed inset-0 z-[9999] bg-white dark:bg-slate-900 flex flex-col items-center justify-center transition-opacity duration-500" style="opacity: 1; display: flex;">
    ...
    <div class="flex min-h-screen w-full overflow-hidden">
        <div class="hidden lg:flex lg:w-1/2 login-split-bg relative items-center justify-center p-12 overflow-hidden">
            <div class="relative z-10 flex flex-col items-center text-center max-w-lg">
                ...
                <p class="text-slate-700 text-lg leading-relaxed">
                    SI CUBIT memudahkan Bidan dan Tenaga Kesehatan untuk memvalidasi data kesehatan Ibu dan Anak secara *real-time* di wilayah Kota Banjarbaru.
                </p>
            </div>
        ...
        <div class="w-full lg:w-1/2 flex flex-col items-center justify-center px-6 md:px-12 lg:px-24 bg-white dark:bg-background-dark">
            <div class="w-full max-w-[440px]">
                <header class="flex flex-col items-start gap-6 mb-10">
                    <div class="flex items-center gap-3">
                        <div class="h-10 w-10 flex items-center justify-center rounded-xl bg-primary text-white shadow-lg shadow-primary/30">
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-slate-500 dark:text-slate-400 text-base">Silakan masuk untuk mengakses Dashboard Petugas.</p>
                    </div>
                </header>

                <form action="<?= base_url('admin/dashboard') ?>" class="flex flex-col gap-6">
                    <div class="flex flex-col gap-2">
                        <label class="text-slate-900 dark:text-slate-100 text-sm font-semibold" for="email">ID Petugas / Email</label>
                        <div class="relative flex items-stretch">
                            <div class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400">
                                <span class="material-symbols-outlined text-[20px]">badge</span>
                            </div>
                            <input class="form-input flex w-full rounded-xl border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 focus:border-primary focus:ring-4 focus:ring-primary/10 h-14 pl-12 pr-4 text-slate-900 dark:text-slate-100 transition-all" id="email" placeholder="NIP atau Email Institusi" required type="text"/>
                        </div>
                    </div>

                    <div class="flex flex-col gap-2">
                        <div class="flex items-center justify-between">
                            <label class="text-slate-900 dark:text-slate-100 text-sm font-semibold" for="password">Password</label>
                            <a class="text-primary text-sm font-semibold hover:underline italic" href="<?= base_url('admin/forgot-password') ?>">Lupa Password?</a>
                        </div>
                        <div class="relative flex items-stretch">
                            <div class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400">
                                <span class="material-symbols-outlined text-[20px]">lock</span>
                            </div>
                            <input class="form-input flex w-full rounded-xl border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 focus:border-primary focus:ring-4 focus:ring-primary/10 h-14 pl-12 pr-12 text-slate-900 dark:text-slate-100 transition-all" id="password" placeholder="••••••••" required type="password"/>
                    ...
                    <button class="flex w-full items-center justify-center h-14 px-6 rounded-xl bg-primary text-white text-base font-bold tracking-wide shadow-lg shadow-primary/20 hover:bg-primary/90 active:scale-[0.98] transition-all" type="submit">
                        Masuk ke Dashboard
                    </button>
                </form>
                ...
                <footer class="mt-12 text-center">
                    <p class="text-slate-500 dark:text-slate-400 text-sm italic">
                        Bukan Petugas? <a class="text-primary font-bold hover:underline" href="<?= base_url('login') ?>">Masuk sebagai Bunda</a>
                    </p>
                    <div class="mt-8 flex items-center justify-center gap-4 text-[10px] text-slate-400 font-bold uppercase tracking-widest">
                        <span>POLTEKKES</span>
                    </div>
                </footer>
            </div>
