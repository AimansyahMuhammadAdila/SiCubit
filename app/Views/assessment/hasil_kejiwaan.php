...
<div class="flex flex-col h-full w-full overflow-hidden bg-slate-50/50 dark:bg-slate-900/40">
    <header class="bg-white dark:bg-slate-900 border-b border-slate-100 dark:border-slate-800 py-6 px-6 md:px-10 flex-shrink-0 z-20 shadow-sm">
        <div class="max-w-4xl mx-auto flex items-center gap-4">
            ...
            <div class="min-w-0">
                <h1 class="text-xl font-bold text-slate-800 dark:text-slate-100 truncate">Hasil Screening Kejiwaan</h1>
                <p class="text-xs md:text-sm text-slate-400 truncate">Informasi kondisi mental dan saran rujukan kesehatan jiwa Bunda.</p>
            </div>
        </div>
    </header>

    <div class="flex-1 overflow-y-auto no-scrollbar p-6 md:p-10 relative z-10 animate-slide-up">
        <div class="max-w-4xl mx-auto pb-24 space-y-6">
            ...
            <?php else: ?>
                ...
                $epdsSkor = $latest['epds_skor'] ?? 0;
                $epdsStatus = $latest['epds_status'] ?? 'Normal / adaptasi emosional ringan';
                $epdsQ10 = $latest['epds_q10'] ?? 0;
                ...
                // Alert check: score >= 10 OR Q10 > 0 (answered anything other than "Tidak pernah")
                    ...
                    <div class="bg-rose-50 dark:bg-rose-950/20 border border-rose-200 dark:border-rose-800 rounded-3xl p-6 md:p-8 flex flex-col md:flex-row items-start gap-4">
                        ...
                        <div class="flex-1 space-y-2">
                            ...
                            <p class="text-sm text-rose-700 dark:text-rose-300/90 leading-relaxed">
                                Bunda terindikasi mengalami <strong><?= $epdsSkor >= 13 ? 'gejala depresi postpartum' : 'gejala baby blues' ?></strong> yang membutuhkan perhatian khusus. 
                                <?php if ($epdsQ10 > 0): ?>
                                    Bunda juga menjawab ada pikiran untuk menyakiti diri sendiri. Hal ini sangat penting untuk ditangani dengan baik.
                                <?php endif; ?>
                                Kami sangat menyarankan Bunda segera melakukan rujukan atau konsultasi ke tenaga profesional kesehatan jiwa (Dokter/Psikolog/Psikiater) atau fasilitas kesehatan terdekat (Puskesmas/Rumah Sakit).
                            </p>
                            <div class="pt-2">
