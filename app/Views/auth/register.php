    ...
    <div class="flex-1 px-8 md:px-16 lg:px-24 pt-8 md:pt-16 pb-12 -mt-4 md:mt-0 bg-white md:bg-transparent relative z-20 flex flex-col justify-center min-h-screen">
        ...
        <form id="registerForm" class="space-y-5 max-w-xl w-full">
            <div class="space-y-4">
                ...
                <div class="relative">
                    <select class="w-full px-5 py-3.5 bg-white border-0 rounded-2xl soft-input-shadow text-sm focus:ring-2 focus:ring-primary/20 text-slate-600 appearance-none transition-shadow" name="id_kabkota">
                        <option disabled selected>Pilih Kab/Kota</option>
                        <option value="banjarmasin">Banjarmasin</option>
                        <option value="banjarbaru">Banjarbaru</option>
                        <option value="tapin">Rantau (Tapin)</option>
                    </select>
                ...
                <div class="relative">
                    <select class="w-full px-5 py-3.5 bg-white border-0 rounded-2xl soft-input-shadow text-sm focus:ring-2 focus:ring-primary/20 text-slate-600 appearance-none transition-shadow" name="id_puskesmas">
                        <option disabled selected>Pilih Puskesmas</option>
                        <option value="1">Puskesmas Rantau</option>
                        <option value="2">Puskesmas Banjarbaru Selatan</option>
                        <option value="3">Puskesmas Sungai Mesa</option>
                    </select>
                    <span class="material-symbols-outlined absolute right-5 top-1/2 -translate-y-1/2 text-slate-400 pointer-events-none">expand_more</span>
                </div>
...
document.getElementById('registerForm').addEventListener('submit', async function(e) {
    ...
    try {
        ...
        if (result.status === 'success') {
            ...
            // Merangkai error dari backend menjadi list HTML yang rapi
