...
<div class="flex flex-col h-full w-full overflow-hidden">
    <!-- HEADER -->
    <header class="bg-white dark:bg-slate-900 border-b border-slate-100 dark:border-slate-800 py-6 px-6 md:px-10 flex-shrink-0 relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto flex items-center gap-4 relative z-10">
            <div class="size-12 rounded-2xl bg-primary/10 flex items-center justify-center text-primary flex-shrink-0">
                <span class="material-symbols-outlined text-3xl font-variation-fill">forum</span>
            </div>
            <div>
                <h1 class="text-xl md:text-2xl font-bold text-slate-800 dark:text-slate-100">Tanya Jawab Seputar Menyusui</h1>
                <p class="text-xs md:text-sm text-slate-400 mt-1">Temukan jawaban cepat untuk keluhan dan kebingungan yang sering Bunda alami.</p>
            </div>
        </div>
    </header>

    <!-- KONTEN FAQ (ACCORDION) -->
