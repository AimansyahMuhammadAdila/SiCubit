...
<div class="flex flex-col h-full w-full">
    ...
    <div id="scrollContainer" class="flex-1 overflow-y-auto no-scrollbar relative z-10 scroll-smooth animate-slide-up">
        <div class="max-w-4xl mx-auto pb-12">
            ...
            <div class="flex p-1 bg-white/80 backdrop-blur rounded-2xl max-w-md mx-auto mb-8 shadow-sm border border-white/60">
                <button id="tabBtnBayi" class="flex-1 py-3 text-sm font-black rounded-xl bg-[#162065] text-white shadow-md transition-all">
                    Data Bayi
                </button>
                <button id="tabBtnAsi" class="flex-1 py-3 text-sm font-bold rounded-xl text-slate-600 hover:text-[#162065] transition-all">
                    Evaluasi ASI
                </button>
            </div>
