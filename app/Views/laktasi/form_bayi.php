...
<div class="flex flex-col h-full w-full overflow-hidden">
    <header class="bg-white dark:bg-slate-900 border-b border-slate-100 dark:border-slate-800 py-6 px-6 md:px-10 flex-shrink-0">
        <div class="max-w-4xl mx-auto flex items-center gap-4">
            ...
            <div>
                <h1 class="text-xl font-bold text-slate-800 dark:text-slate-100">Pembaruan Data Bayi</h1>
                <p class="text-xs md:text-sm text-slate-400">Silakan lengkapi data fisik dan respons refleks tumbuh kembang si kecil.</p>
            </div>
        </div>
    </header>
    ...
    <div class="flex-1 overflow-y-auto no-scrollbar p-6 md:p-10 bg-slate-50/50 dark:bg-slate-900/40">
        <div class="max-w-4xl mx-auto pb-24">
           ...
           <form id="formUpdateDataBayi" action="<?= base_url('api/save-riwayat') ?>" method="POST" class="flex flex-col gap-6 md:gap-8">
